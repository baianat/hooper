...
<script>
    import {cloneSlide, getInRange, normalizeSlideIndex, now, Timer} from './utils';
        ...
        computed: {
            trackTransform() {
                ...
                if (!vertical) {
                    ...
                    let thistransform = "transform: "+this.preSlideTransform+" translate("+(translate - clonesSpace)+"px, 0) "+this.postSlideTransform+" ;";
            ...
            bothTransforms(){
                return this.trackTransform + this.trackTransition;
            }
        },
        methods: {
            // controlling methods
