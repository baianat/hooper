...
|`autoPlay`       |false|enable auto sliding to carousel. This could be changed dynamically. If set to false at startup you have to run restartTimer() after updating for the change to take effect.|
